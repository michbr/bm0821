...
class RentalAgreementTest {
    ...
    public void testCreate() throws Exception {
        ...
        assertEquals(3.0*0.99, agreement.getPreDiscountCharge());
        assertEquals((3.0*0.99)*.2, agreement.getDiscountAmount());
        assertEquals(3.0*0.99 - (3.0*0.99)*.2, agreement.getFinalCharge());
